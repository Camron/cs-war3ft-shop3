...
//new CVAR_wc3_extraarmor;
new CVAR_wc3_cashsteal;
new CVAR_wc3_armorsteal;
new CVAR_wc3_sharpbullets;
new CVAR_wc3_slapcount;
//Long jump tweak
new CVAR_wc3_longjumpvel1;
new CVAR_wc3_longjumpvel2;
new CVAR_wc3_longjumpheight;
...
public CVAR_Init()
{
	...
	//CVAR_wc3_extraarmor				= register_cvar( "wc3_extraarmor"			, "200"							);
	CVAR_wc3_cashsteal			= register_cvar( "wc3_stealcash"				, "100"							);
	CVAR_wc3_armorsteal			= register_cvar( "wc3_armorsteal"				, "5"							);
	CVAR_wc3_sharpbullets		= register_cvar( "wc3_sharpbullets"					, "5"							);
	CVAR_wc3_slapcount			= 	register_cvar( "wc3_slapcount"					, "3"							);
	//Long jump tweak
	CVAR_wc3_longjumpvel1			= 	register_cvar( "wc3_longjumpvel1"					, "500"							);
	CVAR_wc3_longjumpvel2			= 	register_cvar( "wc3_longjumpvel2"					, "500"							);
	CVAR_wc3_longjumpheight			= 	register_cvar( "wc3_longjumpheight"					, "300"							);
