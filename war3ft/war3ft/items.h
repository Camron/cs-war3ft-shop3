...
#define ONEHIT_CHARGES		1
#define SLAP_CHARGES		3

// Item Variable Defines
#define MAX_SHOPMENU_ITEMS  27
...
#define ITEM_MOLE		    17
#define ITEM_ORCPROT		18
#define ITEM_TRUEPROT		19
#define ITEM_STEALCASH		20
#define ITEM_STEALARMOR		21
#define ITEM_SHARPBULLETS	22
#define ITEM_SLAP			23
#define ITEM_LONGJUMP		24
#define ITEM_MIRROR			25
#define ITEM_ONEHIT			26
...
new g_iOneHitCharges[33];		
new g_iSlapCharges[33];
...
new bool:g_bPlayerAlreadyBoughtSlap[33];
new bool:g_bPlayerAlreadyBoughtOneHit[33];
new bool:g_bPlayerHasLongJump[33];
